...
export const fetchAnimeMovies = async (token, page, pageSize) => {
  const response = await fetch(
    `${BASE_URL}/animemovies?page=${page}&pageSize=${pageSize}&type=sorted`,
    {
      method: 'GET',
      headers: {
...
export const searchAnimeMovies = async (token, title) => {
  const response = await fetch(
    `${BASE_URL}/animemovies/search?title=${title}&type=sorted`,
    {
      method: 'GET',
      headers: {
        Authorization: `Bearer ${token}`,
...
export const fetchAnimeShows = async (token, page, pageSize) => {
  const response = await fetch(
    `${BASE_URL}/animeshows?page=${page}&pageSize=${pageSize}&type=sorted`,
    {
      method: 'GET',
      headers: {
        Authorization: `Bearer ${token}`,
...
export const searchAnimeShows = async (token, title) => {
  const response = await fetch(
    `${BASE_URL}/animeshows/search?title=${title}&type=sorted`,
    {
      method: 'GET',
      headers: {
        Authorization: `Bearer ${token}`,
...
export const fetchAnimeByGenre = async (token, type, genre, page, pageSize) => {
  ...
  const response = await fetch(
    `${BASE_URL}/${endpoint}/genre/${genre}?page=${page}&&pageSize=${pageSize}&type=sorted`,
    {
      method: 'GET',
      headers: {
        Authorization: `Bearer ${token}`,
